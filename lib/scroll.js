...
exports.ALIGNMENTS = exports.TIMING_FUNCTIONS = undefined;
...
var TIMING_FUNCTIONS = exports.TIMING_FUNCTIONS = {
...
var ALIGNMENTS = exports.ALIGNMENTS = Object.freeze({
  CENTER: 'CENTER',
  LEFT: 'LEFT',
  RIGHT: 'RIGHT',
  TOP: 'TOP',
...
exports.default = function (target, ctx) {
  ...
  var targetNode = _reactDom2.default.findDOMNode(target);
  if (!targetNode) {
    return;
  }
