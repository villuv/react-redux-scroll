  ...
  return function (Component) {
    ...
    var Scrollable = function (_React$Component) {
      ...
      Scrollable.prototype.componentDidMount = function componentDidMount() {
        ...
        this._domNode = this._domNode || _reactDom2.default.findDOMNode(this);
        this.subscription = (0, _middleware.subscribe)(this.check, this._domNode, this.context.getScrollContext || function () {
          return window;
        }, onEnd, scrollOptions);
      };
    ...
    Scrollable.contextTypes = { getScrollContext: _propTypes2.default.func };

    return (0, _hoistNonReactStatics2.default)(Scrollable, Component);
  };
};