...
var subscribe = exports.subscribe = function subscribe(check, domEl, getContext, onEnd, scrollOptions) {
...
var emit = function emit(action, state, prevState) {
  ...
  Object.keys(subscriptions).map(function (key) {
    ...
    if (!takenContexts.has(subscription.getContext())) {
      ...
      setRunning(key, true);
      subscription.cancelScroll = (0, _scroll2.default)(subscription.domEl, subscription.getContext(), function (canceled) {
