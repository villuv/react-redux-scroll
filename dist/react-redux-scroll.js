(function (global, factory) {
	...
	(factory((global.ReactReduxScroll = {}),global.React));
	...
	*/
	...
	var scrollTo = (function (target, ctx) {
	...
	var subscribe = function subscribe(check, domEl, getContext, onEnd, scrollOptions) {
	...
	var scrollToWhenHoc = (function () {
	  ...
	  return function (Component) {
	    ...
	    var Scrollable = function (_React$Component) {
	      inherits(Scrollable, _React$Component);
	    ...
	    return hoistNonReactStatics_cjs(Scrollable, Component);
	  };
	});

	var scrollableAreaHoc = (function (Component) {
	  if (process.env.IS_SSR) return Component;

	  var ScrollableArea = function (_React$Component) {
	    inherits(ScrollableArea, _React$Component);
	  ...
	  return hoistNonReactStatics_cjs(ScrollableArea, Component);
	});

	exports.createScrollMiddleware = middleware;
	exports.scrollableArea = scrollableAreaHoc;
	exports.scrollToWhen = scrollToWhenHoc;
	exports.ALIGNMENTS = ALIGNMENTS;
	exports.TIMING_FUNCTIONS = TIMING_FUNCTIONS;
